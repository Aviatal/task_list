        ...
        <form method="POST" action="{{ route('tasks.store') }}">
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    id="description"
                    rows="5"
                    class="mt-2 w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600">{{ old('description') }}</textarea>
                @error('description')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    id="long_description"
                    rows="10"
                    class="mt-2 w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600">{{ old('long_description') }}</textarea>
            </div>
